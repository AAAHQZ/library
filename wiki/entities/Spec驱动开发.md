...
Spec 驱动开发是一种将规格说明（Spec）作为核心前置产物的开发方法论，核心理念是：先把规格写够细，再交给 Coding Agent 执行，认为这样能同时提升质量与效率。
...
---
*源文：[你以为在写 Spec，其实是在绕路写代码](https://mp.weixin.qq.com/s/3Nae-CPATJudXgNrJR0vig)*
